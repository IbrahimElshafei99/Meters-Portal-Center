...
namespace PortalUploadingMeterData.Migrations
{
    ...
    [Migration("20240414144524_updateEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortalUploadingMeterData.Models.MasterRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PortalUploadingMeterData.Models.Inspection", b =>
                {
                    b.HasOne("PortalUploadingMeterData.Models.MeterData", "MeterData")
                        .WithOne("MeterInspection")
                        .HasForeignKey("PortalUploadingMeterData.Models.Inspection", "MeterId")
            ...
            modelBuilder.Entity("PortalUploadingMeterData.Models.MeterData", b =>
                {
                    ...
                    b.HasOne("PortalUploadingMeterData.Models.MasterRecord", "MasterRecord")
                        .WithMany("MeterData")
